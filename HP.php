...
<div class="utama">
    <span class="float-left">
		<a class="btn btn-success" href="tambahHP.php">Tambah Data</a>
	</span>
    <!--
	...
	if ($kosong){
		...
		while($row=mysqli_fetch_assoc($hasil)){
			...
			<tr>
				...
				<td>
				<a class="btn btn-outline-primary btn-sm" href="detailHP.php?kode=<?php echo $row['id']?>">Detail</a>
				<a class="btn btn-outline-primary btn-sm" href="editHP.php?kode=<?php echo $row['id']?>">Edit</a>
				<a class="btn btn-outline-danger btn-sm" href="hpsHP.php?kode=<?php echo $row["id"]?>" id="linkHps" onclick="return confirm('Yakin dihapus nih?')">Hapus</a>
				</td>
			</tr>
			<?php 
			$no++;
